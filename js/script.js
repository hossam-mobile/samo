const translations = {
  en: {
    ...
    hero: { title: 'We Build <span class="highlight">Digital</span> Products', subtitle: 'A small team of developers crafting clean, performant software for the modern web.', cta1: 'See Our Work', cta2: 'Book a Free Consultation' },
    ...
    work: { title: 'Our Work', subtitle: 'Real projects, real results.', badge1: 'Featured', badge2: 'Latest', badge3: 'Client Favorite', project1_title: 'Fintech Dashboard', project1_desc: 'Real-time analytics platform handling $2B+ in transactions monthly. Built with React and Node.js.', project2_title: 'E-Commerce Platform', project2_desc: 'Full-featured online store generating 10K+ daily orders with custom CMS and Stripe integration.', project3_title: 'Health App', project3_desc: 'Cross-platform mobile app serving 50K+ patients with appointment management and telemedicine.', case_study: 'View Case Study' },
  ...
  ar: {
    ...
    hero: { title: 'نبني منتجات <span class="highlight">رقمية</span>', subtitle: 'فريق صغير من المطورين يصنعون برامج نظيفة وعالية الأداء للويب الحديث.', cta1: 'شاهد أعمالنا', cta2: 'احجز استشارة مجانية' },
    ...
    work: { title: 'أعمالنا', subtitle: 'مشاريع حقيقية، نتائج حقيقية.', badge1: 'مميز', badge2: 'الأحدث', badge3: 'المفضل لدى العملاء', project1_title: 'لوحة التحكم المالية', project1_desc: 'منصة تحليلات لحظية تعالج أكثر من 2 مليار دولار شهريًا. مبنية باستخدام React و Node.js.', project2_title: 'منصة تجارة إلكترونية', project2_desc: 'متجر إلكتروني متكامل يولد أكثر من 10 آلاف طلب يوميًا مع نظام إدارة محتوى مخصص.', project3_title: 'تطبيق صحي', project3_desc: 'تطبيق جوال عبر المنصات يخدم أكثر من 50 ألف مريض بإدارة المواعيد والاستشارات عن بعد.', case_study: 'عرض دراسة الحالة' },
